...
public class GetAllReviewsForBookTest {
    ...
    @Test
    public void PU05_testGetAllReviewsForBook() {
        List<UserActivity> activities = userActivityService.getAllReviewsForBook("bookId");
        assertThat(activities).isNotEmpty();
        AssertionsForClassTypes.assertThat(activities.size()).isEqualTo(1);
    }

    @Test
    public void PU06_testGetAllReviewsForBook() {
        List<UserActivity> activities = userActivityService.getAllReviewsForBook("book");
        assertThat(activities).isEmpty();
    }

    @Test
    public void PU07_testGetAllReviewsForBook() {
        List<UserActivity> activities = userActivityService.getAllReviewsForBook("");
        assertThat(activities).isEmpty();
    }

    @Test
    public void PU08_testGetAllFollowedActivity() {
        doThrow(new RuntimeException("Simulated Firestore failure"))
                .when(userActivityService)
                .getAllReviewsForBook("");

        assertThrows(RuntimeException.class, () -> {
            userActivityService.getAllReviewsForBook("");
        });
    }
