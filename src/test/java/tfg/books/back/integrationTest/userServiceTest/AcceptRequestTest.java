...
public class AcceptRequestTest {
    ...
    @Test
    public void PU181_AcceptRequest() throws ExecutionException, InterruptedException {
        ...
        Boolean acceptRequest = userService.acceptRequest(userId);

        assertThat(acceptRequest).isNotNull();
        assertThat(acceptRequest).isTrue();
    ...
    @Test
    public void PU182_AcceptRequest() throws ExecutionException, InterruptedException {
        String connectedUserId = "userId3";
        ...
        assertThat(acceptRequest).isNotNull();
        assertThat(acceptRequest).isFalse();
    ...
    @Test
    public void PU183_AcceptRequest(){
        String userId = "userId1";
    ...
    @Test
    public void PU184_AcceptRequest(){
        String connectedUserId = "userId3";
