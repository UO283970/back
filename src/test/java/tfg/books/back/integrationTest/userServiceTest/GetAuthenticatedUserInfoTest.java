...
public class GetAuthenticatedUserInfoTest {
    ...
    public void PU126_GetMinUserInfo() {
        ...
        UserForApp authenticatedUserInfo = userService.getAuthenticatedUserInfo();

        assertThat(authenticatedUserInfo).isNotNull();
        assertThat(authenticatedUserInfo.userId()).isEqualTo("userId1");
        assertThat(authenticatedUserInfo.userAlias()).isEqualTo("userAliasTest".toLowerCase());
    }

    @Test
    public void PU127_GetMinUserInfo() {
        UserForApp authenticatedUserInfo = userService.getAuthenticatedUserInfo();
    ...
    @Test
    public void PU128_GetMinUserInfo() {
