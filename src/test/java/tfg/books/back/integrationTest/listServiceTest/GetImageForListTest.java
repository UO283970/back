...
public class GetImageForListTest {
    ...
    @Test
    public void PU68_GetImageForList() {
        String allListInfo = listService.getImageForList("listId1");
    ...
    @Test
    public void PU69_GetImageForList() {
        String allListInfo = listService.getImageForList("notAListId");
    ...
    @Test
    public void PU70_GetImageForList(){
        doThrow(new RuntimeException("Simulated Firestore failure"))
                .when(listService)
                .getImageForList("notAListId");

        assertThrows(RuntimeException.class, () -> {
            listService.getImageForList("notAListId");
        });
    }
}
