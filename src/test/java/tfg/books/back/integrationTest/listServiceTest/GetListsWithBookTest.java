...
public class GetListsWithBookTest {
    ...
    @Test
    public void PU60_testGetListsWithBook(){
        List<String> basicListInto = listService.getListsWithBook("bookId");
    ...
    @Test
    public void PU61_testGetListsWithBook(){
        List<String> basicListInto = listService.getListsWithBook("notABookId");
    ...
    @Test
    public void PU62_testGetListsWithBook(){
        doThrow(new RuntimeException("Simulated Firestore failure"))
                .when(listService)
                .getListsWithBook("bookId");
