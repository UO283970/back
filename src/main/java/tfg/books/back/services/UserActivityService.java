...
public class UserActivityService {
    ...
    public UserActivity addActivity(@NotNull String activityText, @NotNull int score,
        ...
        //Book book = firestore.collection(AppFirebaseConstants.ACTIVITIES_COLLECTION).document(generatedID) TODO: Esto es una llamada a API.
        UserForSearch userForSearch = userService.getUserMinimalInfo(userId);

        return new UserActivity(activityText,score,userForSearch, null, userActivityType);
    }

    public Boolean deleteActivity(@NotNull String activityId) {
        DocumentReference docRef = firestore.collection(AppFirebaseConstants.ACTIVITIES_COLLECTION).document(activityId);
